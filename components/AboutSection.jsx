      ...
      <div className="my-12 pb-12">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, my name is Pradip Subedi and I am a{" "}
              <span className="font-bold">{"highly ambitious"}</span>,
              <span className="font-bold">{" self-motivated"}</span>, and
              <span className="font-bold">{" driven"}</span> software engineer based in Pokhara, Nepal.
            </p>
            <br />
            <p>
          ...
          <div className="text-center md:w-1/2 md:text-left">
            ...
            <div className="flex flex-wrap flex-row justify-center z-10 md:justify-start">
              {skills.map((item, idx) => {
                return (
                  <p
                    key={idx}
                    className="bg-gray-200 px-4 py-2 mr-2 mt-2 text-gray-500 rounded font- dark:bg-black dark:border dark:text-slate-400"
                  >
                    {item.skill}
                  </p>
                )
            ...
            <Image
              ...
              width={600}
              height={400}
              className="hidden md:block rounded-full md:mt-10 bg-current md:h-52 md:w-96"
            />
          </div>
        </div>
      </div>
